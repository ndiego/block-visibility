				...
				<div className="settings-panel__row">
					<ToggleControl
						label={ interpolateElement(
							...
							{
								strong: <strong/>,
								a: <a href='https://www.blockvisibilitywp.com/documentation/general-settings/?utm_source=plugin&utm_medium=settings&utm_campaign=plugin_referrals' target='_blank' rel="noreferrer" />,
							}
						) }
