 ...
 * @return {string}		 Return the rendered JSX
 */
export function TipACF( props ) {

	return (
		<>
			<h3>{ __( 'Advanced Custom Fields', 'block-visibility' ) }</h3>
			<p>
				{ __(
				...
				{ createInterpolateElement(
					...
					),
					{
						a: (
							<ExternalLink // eslint-disable-line
								href={
									'https://www.blockvisibilitywp.com/knowledge-base/visibility-controls/acf/?bv_query=learn_more'
								}
								target="_blank"
								rel="noreferrer"
							/>
