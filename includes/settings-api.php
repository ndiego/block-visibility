...
class BV_Custom_Route extends WP_REST_Controller {
	...
	*/
	public function get_settings( $request ) {
		$settings = get_option( 'block_visibility_settings', array() );
...
function bv_load_api() {
	$controller = new BV_Custom_Route;

	return $controller->register_routes();
}
//add_action( 'rest_api_init', 'bv_load_api' );
