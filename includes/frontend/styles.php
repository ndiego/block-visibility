...
";
	...
	if ( $large_enabled ) {
		$prevStyles = $styles ? $styles . $spacer : $styles;
		$styles = $prevStyles . "/* Large screens (desktops, {$large} and up) */
...
@media ( min-width: {$extra_large} ) {
	...
	if ( $large_enabled ) {
		$prevStyles = $styles ? $styles . $spacer : $styles;
		$styles = $prevStyles . "/* Large screens (desktops, between {$large} and {$extra_large}) */
...
.block-visibility-hide-medium-screen {
	...
	if ( $small_enabled ) {
		$prevStyles = $styles ? $styles . $spacer : $styles;
		$styles = $prevStyles . "/* Small screens (landscape mobile devices, between {$small} and {$medium}) */
